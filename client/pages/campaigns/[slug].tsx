  ...
  return !loading && data !== undefined ? (
    <>
      ...
      <article className=" divide-y-2 px-7 pt-16 pb-14 ">
        ...
        <ReactMarkdown className="prose prose-stone mx-auto max-w-4xl px-5 py-20 prose-pre:max-h-80 prose-pre:overflow-auto prose-img:mx-auto prose-img:max-h-[70rem] prose-img:max-w-full prose-img:rounded-md lg:prose-xl">
          {data?.description}
        </ReactMarkdown>
      </article>
