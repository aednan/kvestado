...
import CustomNotification, { customToast } from "./CustomNotification";
  ...
  return (
    <>
      ...
      <CustomDialogBox
        ...
        confirmed in the blockchain, your contribution will be
        listed on your profile contributions section."
      />
