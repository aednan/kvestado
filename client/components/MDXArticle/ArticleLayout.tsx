...
const ArticleLayout = ({
  ...
  return (
    <article className=" px-7 pt-16 pb-14 ">
      ...
      <main className="prose prose-stone mx-auto max-w-5xl prose-pre:max-h-80 prose-pre:overflow-auto prose-img:mx-auto prose-img:max-h-[70rem] prose-img:max-w-full prose-img:rounded-md lg:prose-xl">
        {children}
      </main>
    </article>
  );
