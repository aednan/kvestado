...
class App extends Component {
  state = { storageValue: null, provider: null, accounts: null, rContract: null, wContract: null, signer: null };
  ...
  componentDidMount = async () => {
    try {
      ...
      const rContract = new ethers.Contract(contractAddress, FundContract.abi, provider);
      ...
      const wContract = new ethers.Contract(contractAddress, FundContract.abi, signer);
  ...
  //     // example of interacting with the contract's methods.
      this.setState({ provider, accounts, rContract, wContract, signer }, this.runExample);
    } catch (error) {
  ...
  runExample = async () => {
    ...
    // const tx = 
    await wContract.addCampaign('0x259c3bA0d310D37d1897561dB87aDe43CEe31Ed9',
    "sdjkjsdsdkj", true, 50, 1644924091); 
